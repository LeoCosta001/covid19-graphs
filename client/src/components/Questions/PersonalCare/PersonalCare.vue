<template>
  <div class="localContainer">
    <h2 class="title__h2">Cuidados Pessoais</h2>
    <section class="section__content__container">
      <!-- Artigo: Cuidados pessoais importantes -->
      <article>
        <!-- Titulo -->
        <div class="title__h3">
          <hr />
          <h3>Cuidados pessoais importantes</h3>
          <hr />
        </div>
        <!-- Conteúdo -->
        <div class="content__container">
          <div class="new__paragraph">
            <span class="content__title">
              <unicon class="unicon" name="angle-right" width="23px" height="23px" />Higienizar as mãos:
            </span>
            <span class="content__paragraph">
              Uma das maneiras mais eficazes para proteger a si mesmo e aos outros
              do COVID-19 é higienizar as mãos regularmente, principalmente após
              tocar em um mesmo objeto ou superfície que também foi tocado por
              outras pessoas (exemplo: Após fazer compras, usar o transporte público
              ou tocar no dinheiro).
            </span>
            <span class="content__obs">Veja: Maneira correta de higienizar as mãos.</span>
          </div>

          <div class="new__paragraph">
            <span class="content__title">
              <unicon class="unicon" name="angle-right" width="23px" height="23px" />Usar máscara:
            </span>
            <span class="content__paragraph">
              É aconselhado o uso de máscaras cirúrgicas principalmente pelas
              pessoas que já apresentam os sintomas respiratórios e pelos profissionais
              de saúde que prestam atendimento aos indivíduos que apresentam os
              sintomas respiratórios. Porém as pessoas que não apresentam os sintomas
              respiratórios ao usarem máscaras elas têm que se lembrar de todos
              os outros processos de cuidados pessoas, porque a máscara por si
              só não oferece 100% de proteção já que o vírus pode ser transmitido
              quando entra em contato com os olhos, e o uso de máscara faz com que
              a mão da pessoa entre mais vezes em contato com o seu próprio rosto.
            </span>
            <span class="content__obs">Veja: Cuidados com a máscara.</span>
            <span class="content__obs">
              Observação: Na falta de máscaras use um lenço ou a parte interior
              do cotovelo para cobrir a tosse ou o espirro, e fique no mínimo a 1
              metro de distância de outras pessoas.
            </span>
          </div>

          <div class="new__paragraph">
            <span class="content__title">
              <unicon class="unicon" name="angle-right" width="23px" height="23px" />Evitar contato físico:
            </span>
            <span class="content__paragraph">
              Sempre que possível evite o contato físico com outras pessoas,
              principalmente abraços, beijos, aperto de mãos, etc.
            </span>
            <span class="content__obs">
              Observação: Como algumas pessoas infectadas com o COVID-19 podem
              não apresentar os sintomas então sempre que possível fique no
              mínimo a 1 metro de distância das outras pessoas.
            </span>
          </div>
        </div>
      </article>

      <!-- Artigo: Cuidados com a máscara -->
      <article>
        <!-- Titulo -->
        <div class="title__h3">
          <hr />
          <h3>Cuidados com a máscara</h3>
          <hr />
        </div>
        <!-- Conteúdo -->
        <div class="content__container">
          <div class="new__paragraph">
            ...
            <span
              class="content__obs"
            >Observação: A OMS está colaborando com parceiros de pesquisa e desenvolvimento para entender melhor a efetividade e eficiência de máscaras não cirúrgicas.</span>
          </div>
        </div>
      </article>

      <!-- Artigo: Maneira correta de higienizar as mãos -->
      <article>
        <!-- Titulo -->
        <div class="title__h3">
          <hr />
          <h3>Maneira correta de higienizar as mãos</h3>
          <hr />
        </div>
        <!-- Conteúdo -->
        <div class="content__container">
          <div class="new__paragraph">
            <span class="content__title">
              <unicon class="unicon" name="angle-right" width="23px" height="23px" />Como higienizar as mãos com álcool em gel:
            </span>
...
<script src="./PersonalCare.js"></script>
